...
class ActionAuthColumn extends \yii\grid\ActionColumn {
    ...
    protected function initDefaultButtons() {
        $this->buttons['auth'] = FALSE; // Default Button auth

        if (!isset($this->buttons['view'])) {
            $this->buttons['view'] = function ($url, $model) {
                if(($this->buttons['auth']=== FALSE) or ($this->buttons['auth']=== TRUE && $this->buttons['auth']['view']===TRUE)){
        ...
        if (!isset($this->buttons['update'])) {
            $this->buttons['update'] = function ($url, $model) {
                if(($this->buttons['auth']=== FALSE) or ($this->buttons['auth']=== TRUE && $this->buttons['auth']['update']===TRUE)){
        ...
        if (!isset($this->buttons['delete'])) {
            $this->buttons['delete'] = function ($url, $model) {
                if(($this->buttons['auth']=== FALSE) or ($this->buttons['auth']=== TRUE && $this->buttons['auth']['delete']===TRUE)){
